...
{
# 26 "matmul.c"
 *((volatile uint32_t*) 0x35000010) = A;
 *((volatile uint32_t*) 0x35000014) = B;
 *((volatile uint32_t*) 0x35000018) = result;
 *((volatile uint32_t*) 0x35000020) = 4;

 (*(volatile uint32_t*)0x2600000c) = 0xAAAA0000;
 *((volatile uint32_t*) 0x35000000) = 1;

 while(((*((volatile uint32_t*) 0x35000000)) & 0x00000002) == 0x00000000);
 (*(volatile uint32_t*)0x2600000c) = 0xAAFF0000;
