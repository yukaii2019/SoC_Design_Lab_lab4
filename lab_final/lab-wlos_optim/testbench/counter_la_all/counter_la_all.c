...
#ifdef JUPYTER_FIRMWARE
void sync(){
	while((reg_mprj_datal & 0x00001000) == 0x00000000);
...
int* tmp;
	...
	// reg_mprj_datal = 0xAB340000;
	// while((reg_mprj_datal & 0x00001000) == 0x00000000);
	// reg_mprj_datal = 0x00000100;
	// while((reg_mprj_datal & 0x00001000) != 0x00000000);


	// reg_mprj_datal = 0xAB120000;
	// while((reg_mprj_datal & 0x00001000) == 0x00000000);
	// reg_mprj_datal = 0x00000100;
	// while((reg_mprj_datal & 0x00001000) != 0x00000000);

	tmp = matmul();
	reg_mprj_datal = *tmp     << 16; sync();
	reg_mprj_datal = *(tmp+1) << 16; sync(); 
	reg_mprj_datal = *(tmp+2) << 16; sync();
	reg_mprj_datal = *(tmp+3) << 16; sync();
	...
	// reg_mprj_datal = *(tmp+2) << 16; sync();
	// reg_mprj_datal = *(tmp+3) << 16; sync();
	// reg_mprj_datal = *(tmp+4) << 16; sync();
	// reg_mprj_datal = *(tmp+5) << 16; sync();
	// reg_mprj_datal = *(tmp+6) << 16; sync();
	// reg_mprj_datal = *(tmp+7) << 16; sync();
	// reg_mprj_datal = *(tmp+8) << 16; sync();
	// reg_mprj_datal = *(tmp+9) << 16; sync();
	// reg_mprj_datal = *(tmp+10) << 16; sync();	
    // /* QS start */
    // tmp = qsort();
	// reg_mprj_datal = *tmp << 16; sync();
	// reg_mprj_datal = *(tmp+1) << 16; sync();
