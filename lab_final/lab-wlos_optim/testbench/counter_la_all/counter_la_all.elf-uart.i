...
void __attribute__ ( ( section ( ".mprjram" ) ) ) uart_write(int n)
{
    while((((*(volatile uint32_t*)0x30000008)>>3) & 1));
    (*(volatile uint32_t*)0x30000004) = n;
}

void __attribute__ ( ( section ( ".mprjram" ) ) ) uart_write_char(char c)
{
 if (c == '\n')
  uart_write_char('\r');
...
void __attribute__ ( ( section ( ".mprjram" ) ) ) uart_write_string(const char *s)
{
    while (*s)
        uart_write_char(*(s++));
}
...
char __attribute__ ( ( section ( ".mprjram" ) ) ) uart_read_char()
{
 char num;
...
int __attribute__ ( ( section ( ".mprjram" ) ) ) uart_read()
{
    int num;
    if(((((*(volatile uint32_t*)0x30000008)>>5) | 0) == 0) && ((((*(volatile uint32_t*)0x30000008)>>4) | 0) == 0)){
        for(int i = 0; i < 1; i++)
