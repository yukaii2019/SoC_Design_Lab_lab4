...
__attribute__((sdx_kernel("caravel_ps", 0))) void caravel_ps (
 ...
 ap_uint<38> mprj_out,
 ap_uint<38> mprj_en) {
#line 42 "/home/ykhsieh/SoCDesignLab/caravel-soc_fpga-lab_new2/labi/vitis_hls_project/hls_caravel_ps/run_hls.tcl"
...
#pragma HLS INTERFACE ap_none port=mprj_en
 ...
 VITIS_LOOP_51_1: for(i = 0; i < 38; i++) {
#pragma HLS UNROLL
 mprj_in[i] = mprj_en[i] ? ps_mprj_in[i] : mprj_out[i];
 }
