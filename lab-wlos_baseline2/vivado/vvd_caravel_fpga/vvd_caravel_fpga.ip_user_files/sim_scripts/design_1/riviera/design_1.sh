...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/ykhsieh/SoCDesignLab/caravel-soc_fpga-lab_new2/lab-wlos_baseline2/vivado/vvd_caravel_fpga/vvd_caravel_fpga.cache/compile_simlib/riviera"
  fi
