# 0 "counter_la_all.c"
# 1 "/home/ykhsieh/SoCDesignLab/caravel-soc_fpga-lab_new2/lab-wlos_baseline2/testbench/counter_la_all//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "counter_la_all.c"
# 19 "counter_la_all.c"
# 1 "../../firmware/defs.h" 1
# 21 "../../firmware/defs.h"
# 1 "/home/ykhsieh/SoCDesignLab/opt/riscv/lib/gcc/riscv32-unknown-elf/12.1.0/include/stdint.h" 1 3 4
# 11 "/home/ykhsieh/SoCDesignLab/opt/riscv/lib/gcc/riscv32-unknown-elf/12.1.0/include/stdint.h" 3 4
# 1 "/home/ykhsieh/SoCDesignLab/opt/riscv/lib/gcc/riscv32-unknown-elf/12.1.0/include/stdint-gcc.h" 1 3 4
# 34 "/home/ykhsieh/SoCDesignLab/opt/riscv/lib/gcc/riscv32-unknown-elf/12.1.0/include/stdint-gcc.h" 3 4
...
# 12 "/home/ykhsieh/SoCDesignLab/opt/riscv/lib/gcc/riscv32-unknown-elf/12.1.0/include/stdint.h" 2 3 4
# 22 "../../firmware/defs.h" 2
# 1 "/home/ykhsieh/SoCDesignLab/opt/riscv/lib/gcc/riscv32-unknown-elf/12.1.0/include/stdbool.h" 1 3 4
...
# 40 "counter_la_all.c"
void sync(){
 while(((*(volatile uint32_t*)0x2600000c) & 0x00001000) == 0x00000000);
 (*(volatile uint32_t*)0x2600000c) = 0x00000100;
 while(((*(volatile uint32_t*)0x2600000c) & 0x00001000) != 0x00000000);
}
...
# 75 "counter_la_all.c"
     ...
     (*(volatile uint32_t*)0x26000060) = 0x0403;
     (*(volatile uint32_t*)0x2600005c) = 0x0403;
     (*(volatile uint32_t*)0x26000058) = 0x0403;
     (*(volatile uint32_t*)0x26000054) = 0x0403;
...
# 162 "counter_la_all.c"
 (*(volatile uint32_t*)0x2600000c) = 0xAB550000;
 while(((*(volatile uint32_t*)0x2600000c) & 0x00001000) == 0x00000000);
 (*(volatile uint32_t*)0x2600000c) = 0x00000100;
 while(((*(volatile uint32_t*)0x2600000c) & 0x00001000) != 0x00000000);


 (*(volatile uint32_t*)0x2600000c) = 0xAB340000;
 while(((*(volatile uint32_t*)0x2600000c) & 0x00001000) == 0x00000000);
 (*(volatile uint32_t*)0x2600000c) = 0x00000100;
 while(((*(volatile uint32_t*)0x2600000c) & 0x00001000) != 0x00000000);


 (*(volatile uint32_t*)0x2600000c) = 0xAB120000;
 while(((*(volatile uint32_t*)0x2600000c) & 0x00001000) == 0x00000000);
 (*(volatile uint32_t*)0x2600000c) = 0x00000100;
 while(((*(volatile uint32_t*)0x2600000c) & 0x00001000) != 0x00000000);
 ...
 (*(volatile uint32_t*)0x2600000c) = *tmp << 16; sync();
 (*(volatile uint32_t*)0x2600000c) = *(tmp+1) << 16; sync();
 (*(volatile uint32_t*)0x2600000c) = *(tmp+2) << 16; sync();
 (*(volatile uint32_t*)0x2600000c) = *(tmp+3) << 16; sync();
 ...
 (*(volatile uint32_t*)0x2600000c) = *(tmp+2) << 16; sync();
 (*(volatile uint32_t*)0x2600000c) = *(tmp+3) << 16; sync();
 (*(volatile uint32_t*)0x2600000c) = *(tmp+4) << 16; sync();
 (*(volatile uint32_t*)0x2600000c) = *(tmp+5) << 16; sync();
 (*(volatile uint32_t*)0x2600000c) = *(tmp+6) << 16; sync();
 (*(volatile uint32_t*)0x2600000c) = *(tmp+7) << 16; sync();
 (*(volatile uint32_t*)0x2600000c) = *(tmp+8) << 16; sync();
 (*(volatile uint32_t*)0x2600000c) = *(tmp+9) << 16; sync();
 (*(volatile uint32_t*)0x2600000c) = *(tmp+10) << 16; sync();
